...
- C2SIMGUI Editor v2.10.12 works with schemata v1.0.1 and server 4.8.0.0 and up (2020) observation and position reports of OPFOR and others work [link](https://github.com/OpenC2SIM/OpenC2SIM.github.io/blob/master/C2SIMGUIv2.10.12.zip)
...
- C2SIM Reference Implementation Server v4.8.0.12 for C2SIM Standard ontology & schema 1.0.1 (2021) runnable warfile (includes source code) [link](https://github.com/OpenC2SIM/OpenC2SIM.github.io/blob/master/C2SIMServer%23%234.8.0.12.war)
