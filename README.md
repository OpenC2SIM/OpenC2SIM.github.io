...
- C2SIMGUI Editor v2.10.3 works with ontology v1.0.0 and server 4.8.0.0 and up (2020) NOTE:does not build under latest (Apache) NetBeans; use NetBeans 8.1 to build [link](https://github.com/OpenC2SIM/OpenC2SIM.github.io/blob/master/C2SIMGUIv2.10.3.zip)
